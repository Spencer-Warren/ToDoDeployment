...
export class TaskCreateComponent {
  ...
  onSubmit() {
    if (this.taskCreateForm.valid) {
      ...
      let task: TaskNoId = new TaskNoId(this.taskCreateForm.value.title, this.taskCreateForm.value.description, this.taskCreateForm.value.status, newDate, this.app.user);
